...
Iterable<Galaxy> getGalaxies(String line, int rowNumber, Iterable<int> rowsWithoutGalaxies, Iterable<int> columnsWithoutGalaxies) {
    rowNumber = rowNumber + (rowsWithoutGalaxies.count((rowNumberWithoutGalaxy) => rowNumberWithoutGalaxy < rowNumber) * 999999);
    return line.split("").mapIndexed((index, character) => character == "#" ? Galaxy(rowNumber, index + 1 + (columnsWithoutGalaxies.count((columnNumberWithoutGalaxy) => columnNumberWithoutGalaxy < index + 1) * 999999)) : null).whereType();
}
